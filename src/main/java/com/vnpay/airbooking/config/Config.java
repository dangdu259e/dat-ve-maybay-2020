package com.vnpay.airbooking.config;
...
public class Config {
// 2020-08-13, annv, chuyen static field sang application.properties
//     public static String vnp_PayUrl;
//
//     public static String vnp_Returnurl = "http://172.168.80.80:8080/result"; // haotx
//     public static String vnp_TmnCode = "BPF4JLQ3";
//     public static String vnp_HashSecret = "FVMGTYIPZQYBHRLTZWOGYRQYTEDLUEBS";
...
//     public static String orderType = "billpayment";
    ...
    //Util for VNPAY
    public static String hashAllFields(Map fields, @Value("${vnp_HashSecret}") String vnp_HashSecret) throws UnsupportedEncodingException {
